...
detector=muri_binary_640
matcher=NNH-distance16
...
python -m hloc.pipelines.Aachen_v1_1.pipeline --outputs /cluster/work/cvl/kanakism/results/hloc/Aachen_v1_1_${detector}_${matcher} --dataset /cluster/work/cvl/kanakism/datasets/aachen_v1.1/ --num_loc 30
--dataset /cluster/work/cvl/kanakism/datasets/aachen_v1.1/ --detector ${detector} --matcher ${matcher}
