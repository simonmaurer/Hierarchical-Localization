...
from muri.detector_binary import BinaryMURIDetector
...
class MURIBinary(BaseModel):
    ...
    def _init(self, conf):
        ...
        self.detector = BinaryMURIDetector(str(model_path.absolute()), input_shape=(240,320,3), keep_topk_or_threshold=conf['keep_topk_or_threshold'], gpu=conf['gpu'])
